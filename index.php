    ...
    <div class="container">
      ...
      <div class="navbar">
        <ul class="navbar-nav justify-content-end ">
          ...
          <li class="nav-item"><a class="nav-link mt-1 text-dark" href="login.php">
          ...
          <li>
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
              <button class="btn btn-warning mt-2 mx-2 " type="button"><a href="login.php" style=" text-decoration:none " class="text-dark">Sign In</a></button>
            </div>
          </li>
        </ul>
      ...
      <div class="carousel-inner">
        <div class="carousel-item active" style="background-image: url('img/barista coffe-3.png');">
          <div class="container">
            ...
            <p>pesan sekarang kopi kami buat nemenin tugas kamu</p>
          </div>
        </div>
        <div class="carousel-item" style="background-image: url('img/barista coffe-3.png');">
          <div class="container">
            <h5>kamu penikmat kopi</h5>
            <p>cobain kopi yang dibuat menggunakan 100% biji lokal pilihan</p>
          </div>
        </div>
        <div class="carousel-item" style="background-image: url('img/barista coffe-3.png');">
          <div class="container">
            <h5>Yakali ga beli</h5>
            <p>kopi nikmat nyaman diminum</p>
          </div>
  ...
  <div class="container pelayanan" id="pelayanan">
    ...
    <div class="row">
      ...
      <div class="text-center mb-3">
        <h2 class="text-warning">Pelayanan</h2>
        <hr>
      </div>
