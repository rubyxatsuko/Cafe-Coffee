...
if (isset($_POST['update_btn_cart'])) {
    ...
    $update_query   = mysqli_query($conn, "UPDATE cart SET quantity_product = '$update_value' WHERE cart_id = '$update_id'");
    if ($update_query) {
...
if (isset($_GET['remove'])) {
    ...
    mysqli_query($conn, "DELETE FROM cart WHERE cart_id = '$id_remove'");
    header("location: cart.php");
}
            ...
            <div class="col-md-11">
                <table class="table table-responsive-lg table-responsive-md table-responsive-sm text-center mt-3">
                    ...
                    <tbody>
                        ...
                        $grand_total = 0;
                        $cart_select = mysqli_query($conn, "SELECT * FROM cart JOIN product ON cart.id_product=product.id_product WHERE user_id = '$user_id'");
