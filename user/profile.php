...
<body>
    ...
    <div class="container my-3 mt-5 mb-3">
        <div class="d-sm-flex align-items-center justify-content-between text-center">
            <h1 class="h5 mb-0 text-gray-800 text-center">Profile</h1>
        </div>
        <hr>

        <section class="mt-3 justify-content-center" style="background-color: #f4f5f7;">
            <div class="container mb-3 h-80">
