...
<head>
    ...
    <style>
        .card {
            text-align: center;
            /* Mengatur konten di dalam kartu menjadi tengah */
            max-width: 500px;
        ...
        .card img {
            max-width: 100%;
            /* Memastikan gambar tidak melebihi lebar kartu */
            max-height: 100%;
            /* Memastikan gambar tidak melebihi tinggi kartu */
        }
...
<body>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="card mb-1 mt-5">
                <img src="../img/dana.jpg" class="card-img-top" style="height: 500px; width:500px;" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Silahkan Scan QR Ini Untuk Melakukan Pembayaran Melalui Dana atau melalui Link dibawah ini <a href="https://link.dana.id/qr/45096gg2">https://link.dana.id/qr/45096gg2</a></h5>
                    <p class="card-text"><small class="text-body-secondary">Terimakasih Telah Mengunjungi Kedai Kami</small></p>
                </div>
            </div>
        </div>
        <div class="row justify-content-center mt-3">
            <div class="text-end">
                <button class="btn btn-warning" id="btnSelanjutnya">Selanjutnya</button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        document.getElementById("btnSelanjutnya").addEventListener("click", function() {
            ...
            alertDiv.className = "alert alert-success show"; // Menambahkan kelas "show" untuk memunculkan alert
            alertDiv.textContent = "Transaksi telah selesai!";
            document.body.appendChild(alertDiv);

            // Mengarahkan pengguna kembali ke halaman menu setelah 1 detik
            setTimeout(function() {
                window.location.href = "index.php"; // Ganti "menu.php" dengan URL halaman menu yang sesuai
            }, 1000);
        });
    </script>
