    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container mt-3 my-3 mb-5">

                    <div class="container">
                        <div class="d-sm-flex align-items-center justify-content-between">
                            <h1 class="h5 mb-0 text-gray-800">Page Admin - Edit Produk</h1>
                        </div>
                        <hr>
                        ...
                        <div class="row justify-content-center">
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12 mb-4 mt-4">
                                    ...
                                    <input type="text" name="stok" class="form-control" id="stok" value="<?= $row['stok_product']; ?>">
                                </div>
                            ...
                            ?>
                                    ...
                                    $query = mysqli_query($conn, "UPDATE product SET name_product = '$name', price_product = '$price', image_product = '$nama_file', stok_product = '$stok' WHERE id_product = '$id'");
                                    if ($nama_file != '') {
                                    ...
                                    ?>
                                            ...
                                            ?>
                                                ...
                                                $query = mysqli_query($conn, "UPDATE product SET image_product ='$nama_file' WHERE id_product = '$id'");
                                                var_dump($query);
                                                if ($query) {
                                                ?>
