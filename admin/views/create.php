...
?>
      ...
      ?>
            ...
            ?>
               ...
               $query = mysqli_query($conn, "INSERT INTO product (name_product, price_product, image_product, stok_product) VALUES ('$name', '$price', '$new_name', '$stok')");
         ...
         <div id="content">
            ...
            <div class="container mt-5 my-3 mb-5">
               <div class="d-sm-flex align-items-center justify-content-between">
                  <h1 class="h5 mb-0 text-gray-800">Page Admin - Tambah Produk</h1>
               </div>
               <hr>
               ...
               <div class="row justify-content-center mb-5">
                  <form action="" method="POST" enctype="multipart/form-data">
                     ...
                     <div class="col-md-12 mb-4 mt-4">
                        ...
                        <input type="text" name="stok" class="form-control" placeholder="isi sesuai dengan stok yang tersedia" id="stok">
                     </div>
                     <div class="col-md-12 mb-4 mt-4">
                     ...
                     <button type="submit" class="btn btn-primary mt-2 mb-5" name="tambah">Simpan Produk</button>
                  </form>
               </div>
            </div>
